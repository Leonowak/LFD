...
#Title: Distilbert-base-uncased model for Multi-class classification tasks

#Purpose: This script is designed to run a baseline version of the pre-trained Distilbert-base-uncased model on a corpus including labeled reviews.
