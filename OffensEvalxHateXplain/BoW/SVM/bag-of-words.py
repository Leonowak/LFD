...
def create_arg_parser():
    ...
    parser.add_argument("-tf", "--train_file", default='train_offens.json', type=str, help="Train file to learn from")
    parser.add_argument("-df", "--dev_file", default='dev_offens.json', type=str, help="Dev file to evaluate on")
...
if __name__ == "__main__":
    ...
    report = classification_report(Y_test, Y_pred, target_names = ["OFF", "NOT"])
