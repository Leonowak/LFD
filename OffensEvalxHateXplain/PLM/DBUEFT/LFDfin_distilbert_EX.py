...
def create_arg_parser():
    ...
    parser.add_argument("-tE", "--testE_file", type=str, default='test_offenseval_hatexplain', help="If added, use trained model to predict on the test set")
    parser.add_argument("-trE", "--trainE_file", default='train_offenseval_hatexplain.json', type=str, help="Input file to learn from (default train.json)")
    parser.add_argument("-dE", "--devE_file", type=str, default='dev_offenseval_hatexplain.json', help="Separate dev set to read in (default dev.json)")
...
def main():
    ...
    X_train, Y_train = read_corpus(args.trainE_file)
    X_dev, Y_dev = read_corpus(args.devE_file)
    ...
    if args.testE_file:
        X_test, Y_test = read_corpus(args.testE_file)
